      ...
      <div id="sidecanvas" >
        ...
        <FOREACH var='p' in=':user' type='list'>
          <div class="panel panel-default">
            ...
            <!-- List group -->
            <ul class="list-group">
              <a href="#" class="list-group-item">Questions <span class="badge"><%= [expr {[::nx::var exists $p postings] ? [llength [ns_quotehtml [get_value2 p postings]]] : {0}}]%></span></a>
              <a href="#" class="list-group-item">Comments <span class="badge"><%= [expr {[::nx::var exists $p comments] ? [llength [ns_quotehtml [get_value2 p comments]]] : {0}}]%></span></a>
              <a id="newQuestion" class="list-group-item">New Question</a>
              <a id="logout" class="list-group-item"><b>Logout</b></a>
            </ul>
          </div>
        </FOREACH>
        </div>
